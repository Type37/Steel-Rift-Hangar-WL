...
export const ADVANCED_ASSETS = [
  { name: 'LAS-Wing Attack Squadron',     cost: 10, kind: 'Air',
    summary: '4 light flyers, modular Strike or Recon loadouts.',
    fullDesc: 'A Squadron of 4 LAS-Wings. Mix and match Strike LAS Wings (Autocannon or Rotary Cannon, AG Missiles or Barrage Rockets) with Reconnaissance and Disruption LAS Wings (Autocannon or Rotary Cannon, plus Guidance Suite, MSOE Launcher, Scramblers).',
  ...
  { name: 'LAS-Wing Transport Squadron',  cost: 10, kind: 'Air',
    ...
    fullDesc: 'A Squadron of LAS-Wing Transports of one type. Infantry Air Transport carries 3 Infantry Squads. Power Suit Air Transport carries 2 Power Suit Squads. UL HE-V Air Transport carries 1 UL HE-V Squadron (purchased separately as its own Support Asset).',
    stats: { 'Per model': 'SPD 12", ARM 1, STR 2', Weapons: 'Rotary Cannon', Traits: 'Auxiliary Unit (Light), Flying, Flying Squadron, Vulnerable, Yielding' } },
  { name: 'Assault Vehicle Squadron',     cost: 20, kind: 'Vehicle',
    summary: '4 ground vehicles in any combination.',
    fullDesc: 'A Squadron of 4 Assault Vehicles drawn from: Netter, Demolition, Infantry Fighting (carries 3 Infantry Squads), Combat Engineering, Shield Projector, Fire Support, Anti-Aircraft, or Artillery.',
  ...
  { name: 'Heavy Tank Troop',             cost: 20, kind: 'Vehicle',
    summary: '2 heavy tanks, HE-V scale weapons.',
    fullDesc: 'Pick any 2 from: Direct Fire (Tank Laser + Submunitions), General Fire Support (Tank Autocannon + Vehicle Rocket Pack + Submunitions), Missile Battery (Tank Missiles ×2), or Infantry Assault (Tank Howitzer + Rotary Cannon + Dozer Blade + Submunitions; carries 4 Infantry Squads). Each tank scores as 10 Tons.',
  ...
  { name: 'Infantry Outpost',             cost: 10, kind: 'Garrison',
    summary: '2 fortified bunkers with garrisoned squads.',
    fullDesc: 'Two Bunkers, each with a single Weapon (Autocannon, Missile Pack, or Rocket Pack) and 6 Infantry Squad Models garrisoned inside. Each Bunker scores as 5 Tons.',
  ...
  { name: 'Support Vehicle Squadron',     cost: 20, kind: 'Vehicle',
    summary: '4 specialist support vehicles.',
    fullDesc: 'A Squadron of 4 Support Vehicles. No type may be taken more than twice. Pick from: Recon Vehicle (Target Designator, Outrider), Command Vehicle, Resupply Vehicle, Targeting Support, Obscuration Projector, or Minelayer Vehicle.',
